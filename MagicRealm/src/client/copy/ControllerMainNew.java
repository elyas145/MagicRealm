...
public class ControllerMainNew implements ClientController {
	...
	private ClientServerCopy server;
	private int sleepTime = 2000;

	private MenuItemListener mainMenuListener;

	public ControllerMainNew() {
		rh = new ResourceHandler();
		mainView = new LWJGLViewController(rh);
		sounds = new JogAmpSoundController();

		server = new ClientServerCopy(this);
